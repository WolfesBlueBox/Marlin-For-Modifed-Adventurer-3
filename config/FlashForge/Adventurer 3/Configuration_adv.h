 ...
 */
#define USE_CONTROLLER_FAN                   //WF
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN 2           // Set a custom pin for the controller fan WF uses fan port 0
  ...
  #define CONTROLLERFAN_SPEED_IDLE          // (0-255) Idle speed, used when motors are disabled
  #define CONTROLLERFAN_IDLE_TIME        30 // (seconds) Extra time to keep the fan running after disabling motors (60) WF 
 ...
 */
#define FAN_KICKSTART_TIME  120  // (ms) //WF
 ...
 */
//#define CASE_LIGHT_ENABLE //WF
#if ENABLED(CASE_LIGHT_ENABLE)
  //#define CASE_LIGHT_PIN 4                  // Override the default pin if needed
  #define INVERT_CASE_LIGHT false             // Set true if Case Light is ON when pin is LOW
  #define CASE_LIGHT_DEFAULT_ON true          // Set default power-up state on
  //#define CASE_LIGHT_DEFAULT_BRIGHTNESS 105   WF // Set default power-up brightness (0-255, requires PWM pin)
  #define CASE_LIGHT_NO_BRIGHTNESS          // Disable brightness control. Enable for non-PWM lighting.
  //#define CASE_LIGHT_MAX_PWM 128            // Limit PWM duty cycle (0-255)
  #define CASE_LIGHT_MENU                   // WF Add Case Light options to the LCD menu
...
#define SENSORLESS_BACKOFF_MM  { 20, 20, 0 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing WF
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first WF
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define BINARY_FILE_TRANSFER  // WF needs to enabled when enabling sd card support

  #if ENABLED(BINARY_FILE_TRANSFER)
    // Include extra facilities (e.g., 'M20 F') supporting firmware upload via BINARY_FILE_TRANSFER
    #define CUSTOM_FIRMWARE_UPLOAD // WF needs to enabled when enabling sd card support
  #endif
 ...
 */
//#define DISPLAY_SLEEP_MINUTES 10       // WF (minutes) Timeout before turning off the screen
 ...
 */
#define ADVANCED_PAUSE_FEATURE  //WF
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. WF
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. WF
 ...
 */
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only  WF
    ...
    #define IMPROVE_HOMING_RELIABILITY //WF
    #define SENSORLESS_STALLGUARD_DELAY   60 // (ms) Delay to allow drivers to settle WF

    #if HAS_MARLINUI_MENU
      // Convenient homing menu items next to Sensorless Homing edit items
      #define SENSORLESS_HOMING_TEST_MENU_ITEMS //WF
    #endif
 ...
 * @section calibrate
 */
#define MECHANICAL_GANTRY_CALIBRATION  //WF auto z align
