...
#define STRING_CONFIG_H_AUTHOR "WolfesBlueBox" // Original author or contributor. WF
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0  // big tree tech skr mini 3 v3 WF
#endif
 ...
 */
#define SERIAL_PORT -1 //(?)  set to 1 for dummy port. set to -1 or 0 for normal WF
 ...
 */
#define BAUDRATE 115200 // WF was 250000
...
#define CUSTOM_MACHINE_NAME "WulfForge" //WF
//#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "1f858680-4915-4ee7-8689-44a590342d76" //WF
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //WF
#define Y_DRIVER_TYPE  TMC2209 //WF
#define Z_DRIVER_TYPE  TMC2209 //WF
...
#define E0_DRIVER_TYPE TMC2209 //WF
 ...
 * 
 * below are only needed for more non-standard machines. WF
 */
//#ifdef I_DRIVER_TYPE 
  //#define AXIS4_NAME 'A' // :['A', 'B', 'C', 'U', 'V', 'W']
  //#define AXIS4_ROTATES
//#endif
//#ifdef J_DRIVER_TYPE //y - axis
  //#define AXIS5_NAME 'B' // :['B', 'C', 'U', 'V', 'W']
  //#define AXIS5_ROTATES
//#endif
//#ifdef K_DRIVER_TYPE //z - axis
  //#define AXIS6_NAME 'C' // :['C', 'U', 'V', 'W']
  //#define AXIS6_ROTATES
//#endif
//extruders are assigned e0 vaules so do not need to be assigned here
//#ifdef U_DRIVER_TYPE
...
#if ENABLED(SINGLENOZZLE) //leave enabled for auto mid print swaps.
...
//#if ANY(PARKING_EXTRUDER, MAGNETIC_PARKING_EXTRUDER)
 ...
 //#define PARKING_EXTRUDER_PARKING_X { -78, 184 }     // X positions for parking the extruders (?) homing
 ...
 */
#define TEMP_SENSOR_0 5 // 5 : 100kΩ ATC Semitec 104GT-2/104NT-4-R025H42G J-head e3d v6 WF
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_KD 114.00 //WF edit these after pid autotune?
  #endif
#else
...
//#define ENDSTOPPULLUPS
  ...
  #define ENDSTOPPULLUP_XMAX //WF
  #define ENDSTOPPULLUP_YMAX  //WF
  ...
  //#define ENDSTOPPULLUP_ZMIN_PROBE  (?) define probe as an endstop
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 33.9, 33.9, 6.25, 33.5 } //WF
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 800, 800, 30, 30 } //WF
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6500, 6500, 400, 2000 }
 ...
 */
#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration for printing moves WF
#define DEFAULT_RETRACT_ACCELERATION  2000    // E acceleration for retracts WF
#define DEFAULT_TRAVEL_ACCELERATION   3000    // X, Y, Z acceleration for travel (non printing) moves WF
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013 // (mm) Distance from real junction edge WF : a lower number = higher speed. 
...
/**
 * Z Servo Probe, such as an endstop switch on a rotating arm. WF : add Slide swipe here.
 */
...
#define INVERT_E0_DIR true // WF reverse extruder direction to push filament forward into the hotend
...
// The size of the printable area WF
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  //WF
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25 //WF
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 WF
...
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 //WF
